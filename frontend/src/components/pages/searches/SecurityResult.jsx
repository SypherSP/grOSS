  ...
  return (
    ...
    <>
      ...
      {infoScan.length > 0 && (
        ...
        <div className="card" style={{ margin: "5% 5% 2% 5%", backgroundColor: "#0d1117", border: "1px #30363d solid" }} id="info_scan">
        <h2 className="card-header"> Potentially Sensitive Information </h2>
        <ul>
      ...
      {rbScan.length > 0 && (
          <div className="card" style={{ margin: "2% 5% 2% 5%", backgroundColor: "#0d1117", border: "1px #30363d solid" }} id="rb_scan">
          <h2 className="card-header" > Static Ruby code analysis </h2>
          <ul>
      ...
      {pyScan.length > 0 && (
          <div className="card" style={{ margin: "2% 5% 2% 5%", backgroundColor: "#0d1117", border: "1px #30363d solid" }} id="py_scan">
          <h2 className="card-header"> Static Python code analysis </h2>
          <ul>
      ...
      {njsScan.length > 0 && (
          <div className="card" style={{ margin: "2% 5% 2% 5%", backgroundColor: "#0d1117", border: "1px #30363d solid" }} id="rb_scan">
          <h2 className="card-header" > Static Node JS code analysis </h2>
          <ul>
